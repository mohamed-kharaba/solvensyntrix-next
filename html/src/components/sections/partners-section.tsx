...
}[] = [
  {
    ...
    wordmark: (
      <span className="flex items-center gap-2.5 h-9">
        ...
        <svg
          viewBox="0 0 24 24"
          className="h-8 w-8 shrink-0 fill-current transition-colors duration-300 group-hover:fill-[#FF9900]"
        ...
        <span
          className="font-bold text-2xl tracking-tight transition-colors duration-300 group-hover:text-[#FF9900]"
  ...
  },
  {
    ...
    wordmark: (
      <span className="flex items-center gap-2.5 h-9">
        ...
        >
          <path
            className="transition-colors duration-300 group-hover:fill-[#4285F4] fill-current"
            d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"
          />
          <path
            className="transition-colors duration-300 group-hover:fill-[#34A853] fill-current"
            d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z"
          />
          <path
            className="transition-colors duration-300 group-hover:fill-[#FBBC05] fill-current"
            d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z"
          />
          <path
            className="transition-colors duration-300 group-hover:fill-[#EA4335] fill-current"
        ...
        <span
          ...
          style={{ fontFamily: "Arial, sans-serif" }}
        >
          <span className="transition-colors duration-300 group-hover:text-[#4285F4]">
            G
          </span>
          <span className="transition-colors duration-300 group-hover:text-[#EA4335]">
            o
          </span>
          <span className="transition-colors duration-300 group-hover:text-[#FBBC05]">
            o
          </span>
          <span className="transition-colors duration-300 group-hover:text-[#4285F4]">
            g
          </span>
          <span className="transition-colors duration-300 group-hover:text-[#34A853]">
            l
          </span>
          <span className="transition-colors duration-300 group-hover:text-[#EA4335]">
            e
  ...
  },
  {
    ...
    wordmark: (
      <span className="flex items-center gap-2.5 h-9">
        ...
        <span
          className="font-semibold text-2xl tracking-tight group-hover:text-[#0078D4] transition-colors duration-300"
  ...
  },
  {
    ...
    wordmark: (
      <span className="flex items-center gap-2.5 h-9">
        <svg
          viewBox="0 0 24 24"
          className="h-8 w-8 shrink-0 fill-current transition-colors duration-300"
          xmlns="http://www.w3.org/2000/svg"
        >
        ...
        <AnimatedSection variant="fade-up" delay={0.15}>
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-px bg-hairline border border-hairline rounded-ds-lg overflow-hidden">
            ...
            {TECH_PARTNERS.map((partner) => (
              ...
              >
                <span className="opacity-40 text-current">
                  {partner.wordmark}
                </span>
              </LogoCard>
            ))}

            {/* Row 2: partner logos (PNG/WebP) */}
